...
class EnforceUserLogin(object):
    ...
    def process_response(self, request, response):
        ...
        response.content = response.content + "<script>element=document.getElementById('branding-footer');if(element!=null){element.parentNode.removeChild(element);}</script>"
        return response
